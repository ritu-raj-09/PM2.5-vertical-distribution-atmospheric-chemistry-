...
#opening file
      ...
      for file in files:
          ...
          dayAvgs.append(np.mean(SO4, axis=0))
      ...
      ax = plt.plot(p,levs,c=color[i],label = MAH[i-1])
      plt.xlim(0, 20)
      if i==1:
            ...
            pass
      plt.ylim(1000, 100)
      plt.xlabel('CONC.SO4(\u03BC g per meter cube)')
      plt.ylabel('Pressure hPa')
      plt.title('NAINITAL VERTICAL PROFILE (AVERAGE FOR MONTH) 2021' )##note: please change the name according to city
      plt.legend()
      if i==12:
            #plt.savefig(r'C:\Users\tryri\Desktop\withwindmag\VPALL'+'\\'+ 'NAINITAL.png')###note: please change the name according to city
            plt.show()
      else:
            pass
