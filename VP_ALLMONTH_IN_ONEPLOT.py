...
for i in range(1,13):
     ...
     #THESE ARE BOUNDED LAT AND LONS OF PATICULAR LOCATION 
      #NAINITAL
      '''latbounds = [ 29 , 30 ]
      lonbounds = [ 79 , 80 ]
...
#opening file
      ...
      if i==1:
            ...
            pass
      plt.ylim(1000, 100,-100)
      plt.xlabel('PM2.5 Concentration (\u03BCg/m\u00b3)')
      plt.ylabel('Pressure hPa')
      plt.title('BHUBANESWAR VERTICAL PROFILE  2021' )##note: please change the name according to city
      plt.legend()
      if i==12:
            plt.savefig(r'C:\Users\tryri\Desktop\\vp'+'\\'+ 'BHUBANESWAR.png')###note: please change the name according to city
            plt.show()
      else:
            pass
